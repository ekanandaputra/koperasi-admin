...
import com.example.koperasi_admin.Menu.DetailPendaftaranActivity
...
class AdapterPendaftaran(private val context: Context, private val arrayList: ArrayList<User>) : RecyclerView.Adapter<AdapterPendaftaran.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(context, DetailPendaftaranActivity::class.java)
